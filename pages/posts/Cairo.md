...
[StarkWare series] Cairo가 프로그램의 유효성을 증명하는 방법
TL;DR
...
"nondeterministic Cairo machine은 input이 ( T, m\*, pc*I, pc_F, ap_I, ap_F )일 때 accept 한다."
...
이 바이트코드에 의해 partial memory function은 m*(0) = 0x480680017fff8000, m*(1) = 1, m*(2) = 0x480680017fff8000, … 와 같이 설정된다. pc값은 pc*I = 0 + 0, pc_F = 0 + 10로 설정된다.
